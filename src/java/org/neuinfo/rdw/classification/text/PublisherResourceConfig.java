...
public class PublisherResourceConfig extends AbstractConfig {
	...
	public final static String DEFAULT_svmModelDir = "svm_pr";
	public final static String DEFAULT_svmTestFile = "svm/pr_classify.dat";
	public final static String DEFAULT_svmTrainFile = "svm/pr_train.dat";
	public final static String DEFAULT_featureIndicesFile = "pr_feature_indices.xml";

	public PublisherResourceConfig(String workDir) throws Exception {
		super(workDir);
		init();

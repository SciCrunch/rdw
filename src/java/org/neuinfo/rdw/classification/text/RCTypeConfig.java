...
public class RCTypeConfig extends AbstractConfig {
	...
	public final static String DEFAULT_svmTestFile = "svm/rct_classify.dat";
	public final static String DEFAULT_svmTrainFile = "svm/rct_train.dat";
	public final static String DEFAULT_featureIndicesFile = "feature_indices.xml";

	public RCTypeConfig(String workDir) throws Exception {
		super(workDir);
		init();
	...
	public String getOVASVMTrainFile(String classifierName) {
		classifierName = classifierName.replaceAll(
				"[\\.!\\?,;:\\-&='\"()\\[\\]\\s/]+", "_");
		String s = this.svmTrainFile.replaceFirst("\\.dat$", "_"
				+ classifierName + ".dat");
		return s;
	}

	public String getOVASVMModelFile(String classifierName) {
		classifierName = classifierName.replaceAll(
				"[\\.!\\?,;:\\-&='\"()\\[\\]\\s/]+", "_");
		String s = new File(this.svmModelDir, classifierName + ".mdl")
				.getAbsolutePath();
		return s;
	}

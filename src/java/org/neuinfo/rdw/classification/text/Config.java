...
public class Config extends AbstractConfig {
	...
	public final static String DEFAULT_svmTestFile = "svm/registry_classify.dat";
	public final static String DEFAULT_svmTrainFile = "svm/registry_train.dat";
	public final static String DEFAULT_featureIndicesFile = "feature_indices.xml";

	public Config(String workDir) throws Exception {
		super(workDir);
		init();
